function Staircase(stairs) {
  ...
  for (var i in stairs) {
    ...
    this.stairs[i].operation = stairs[i].operation || 'multiply';
...
Staircase.prototype.setsameStairMax = function (max, stair) {
  ARG('setsameStairMax', arguments, 2);
  UNDEFINED(this.stairs, stair);
